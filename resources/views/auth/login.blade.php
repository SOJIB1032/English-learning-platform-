...
<style>
    ...
    .flit.a { top: 10px; left: 8px; animation-delay: 0s; }
    .flit.b { top: 30px; right: 4px; animation-delay: 1.1s; }
    .flit.c { bottom: 40px; left: -6px; animation-delay: 2.1s; }
    ...
    .form-check-input:checked {
        background-color: var(--teal, #0f5257);
...
<div class="container py-5">
    <div class="auth-stage">
        ...
        <div class="diorama" id="diorama">
            ...
            <div class="caption">
                <h3>Learn English, Grow Confidence</h3>
                <p>ইংরেজি শিখুন, আত্মবিশ্বাসী হোন — প্রতিদিন একটু একটু করে এগিয়ে যান।</p>
            </div>
        ...
        <div class="form-panel">
            <div class="form-card">
                ...
                <h2>Welcome Back</h2>
                <p class="subtitle">আপনার অ্যাকাউন্টে লগ ইন করুন</p>
                ...
                <form method="POST" action="{{ route('login.submit') }}">
                    ...
                    <div class="field-3d mb-1">
                        ...
                        <div class="input-group input-3d">
                            ...
                            <button type="button" class="btn toggle-eye" onclick="togglePassword()">
                ...
                <p class="text-center mb-0 small">
                    ...
                    <a href="{{ route('register') }}" class="form-link">Register Now</a>
                </p>
...
// Parallax: the whole diorama rig responds to cursor position, like looking into a diorama box
(function () {
